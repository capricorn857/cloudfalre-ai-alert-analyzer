/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareWorkerEnv` (hash: e06dfa27522284489c8c76e717cd5de1)
// Runtime types generated with workerd@1.20260915.1 2026-09-16 
interface __BaseEnv_CloudflareWorkerEnv {
	ALERT_QUEUE: Queue;
	BUSINESS_CONFIG: {"beforeMinutes":30,"settleSeconds":60,"sampleLimit":50,"requestTimeoutMs":10000,"llmTimeoutMs":30000,"llmMaxOutputTokens":2048,"retryCount":2,"displayTimeZone":"Asia/Shanghai","rules":{"ipConcentration":{"medium":30,"high":50},"pathConcentration":{"medium":30,"high":50},"countryConcentration":{"medium":40,"high":70},"asnConcentration":{"medium":40,"high":70},"allowRatio":{"medium":50,"high":80},"blockRatio":{"medium":50,"high":80},"userAgentConcentration":{"medium":50,"high":80},"requestRate":{"medium":5,"high":20}}};
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_CloudflareWorkerEnv {}
}
interface CloudflareWorkerEnv extends __BaseEnv_CloudflareWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUSINESS_CONFIG" | "CLOUDFLARE_API_TOKEN" | "LLM_API_KEY" | "WECOM_WEBHOOK_URL">> {}
}
